...
def add_model_config_args(parser):
    ...
    group.add_argument("--base", type=str, nargs="*", default=["./tools/CogVideo/configs/cogvideox_5b_v2v.yaml", "./tools/CogVideo/configs/inference_v2v.yaml"], help="config for input and saving")
    group.add_argument(
